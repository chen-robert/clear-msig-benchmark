...
pub fn param_byte_size(param_type: ParamType, params_data: &[u8], offset: usize) -> Result<usize> {
    match param_type {
...
// --- Pod/Zeroable impls (Quasar auto-generates these via its macro) ---

macro_rules! impl_pod {
    ($($t:ty),* $(,)?) => {
        $(
            unsafe impl anchor_lang_v2::bytemuck::Zeroable for $t {}
            unsafe impl anchor_lang_v2::bytemuck::Pod for $t {}
        )*
    };
}
